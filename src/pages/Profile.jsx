...
// const Profile = () => {
//   const [customer, setCustomer] = useState(currentEmployee);
...
const Profile = () => {
  ...
  const userPhone = localStorage.getItem("userPhone") || "+91XXXXXXXXXX";
  
  // Default employee data for fallback
      ...
      <main className="flex-1 container py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="border-border/50 block sm:hidden">
              <CardContent className="p-4">
